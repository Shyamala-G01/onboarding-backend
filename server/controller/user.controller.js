...
const addPersonalInfo = async (req, res) => {
  ...
  const userData = await sequelize.query(
    `INSERT INTO personal_info(first_name,last_name,dob,gender,mobile_number,alternate_number,personal_email,photo,created_at,updated_at,updated_by,fk_person_users_id) VALUES(${personData.first_name},${personData.last_name},${personData.dob},${personData.gender},${personData.mobile_number},${personData.alternate_number},${personData.personal_email},${personData.photo},${personData.created_at},${personData.updated_at},${personData.updated_by})`
  );
  if (userData) {
