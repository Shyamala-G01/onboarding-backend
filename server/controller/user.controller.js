...
const getStatus= async(req,res)=>{
  ...
  const otherDetails= await user.findOne({where:{fk_proof_users_id:reqId}, attributes: ['status']})
  const declaration= await user.findOne({where:{fk_declaration_users_id:reqId}, attributes: ['status']})
